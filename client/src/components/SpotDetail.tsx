...
export default function SpotDetail({ selectedSpot, recentReports, onClose }: any) {
  ...
  return (
    <div className="absolute bottom-8 left-8 w-96 bg-white rounded-lg shadow-2xl p-6 z-50">
      ...
      <div className="flex gap-2">
        <button className="flex-1 bg-blue-600 text-white py-2 rounded-lg hover:bg-blue-700 font-medium">Add Report</button>
